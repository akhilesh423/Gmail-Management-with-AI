    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="space-y-4">
        ...
        <div className="flex space-x-4">
          <a href="https://github.com/akhilesh423/Gmail-Management-with-AI" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-800">
          ...
          <a href="https://www.linkedin.com/in/d-akhilesh-24ba8a230/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-800">
